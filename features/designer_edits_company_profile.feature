Feature: Designer edits company profile
  ...
  Background:
    ...
    And the "Company Name" field contains "Spider Themes"
    And the "Email Address" field contains "contact@spider.thm"
  ...
  Scenario: Cancelling editing of company profile
    When I click "Cancel"
    Then I should be on the edit company profile page
    And the "Company Name" field should contain "Spider Themes"
    And the "Email Address" field should contain "contact@spider.thm"
