  ...
  describe 'PUT update' do
    ...
    context "valid attributes" do
      it "located the requested business" do
        put :update, id: @business, business: Fabricate.attributes_for(:business)
        assigns(:business).should == @business
      end

      it "changes the attributes of business" do
        put :update, id: @business,
          business: Fabricate.attributes_for(:business, name: "Awesome Themes", email: "contact@awesome.thm")
        @business.reload
    ...
    context "invalid attributes" do
      it "locates the requested business" do
        put :update, id: @business, business: Fabricate.attributes_for(:business, name: nil)
        assigns(:business).should == @business
      end

      it "does not change attributes of business" do
        put :update, id: @business,
          business: Fabricate.attributes_for(:business, email: nil)
        @business.reload
